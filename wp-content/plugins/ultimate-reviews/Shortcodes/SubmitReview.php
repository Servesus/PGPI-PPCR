...
function EWD_URP_Add_Default_Field($Review_Category_Item, $product_name, $Logged_In_User) {
	...
	elseif ($Review_Category_Item['CategoryName'] == "Review Category (if applicable)" and $Review_Category == "Yes") {$ReturnString .= EWD_URP_Add_Review_Category_Field($Review_Category_Item['CategoryRequired']);}
