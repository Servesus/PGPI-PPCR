...
<?php if ($URP_Full_Version != "Yes" or get_option("EWD_URP_Trial_Happening") == "Yes") { ?>
	...
	<div class="ewd-urp-dashboard-new-upgrade-banner">
		...
		<div class="ewd-urp-dashboard-banner-buttons">
			<a class="ewd-urp-dashboard-new-upgrade-button" href="https://www.etoilewebdesign.com/plugins/ultimate-reviews/#plugin-sales-plans" target="_blank">UPGRADE NOW</a>
		</div>
		<div class="ewd-urp-dashboard-banner-text <?php echo ( $display_trial_banner ? 'ewd-urp-bf-banner' : '' ); ?>">
			<!-- Start Black Friday -->
			<?php if ( $display_trial_banner ) { ?>
			<div class="ewd-urp-dashboard-banner-black-friday-text">
				<div class="ewd-urp-dashboard-banner-black-friday-title">
					30% OFF PREMIUM FOR BLACK FRIDAY!
				</div>
				<div class="ewd-urp-dashboard-banner-black-friday-brief">
					Upgrade now to receive this great discount. No coupon code necessary. November 28th to December 2nd EST.
				</div>
				<div class="ewd-urp-dashboard-banner-black-friday-brief-mobile">
