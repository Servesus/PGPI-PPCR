...
= NEW: PRO Add-on Pick up and Delivery Functionality =

* Allow customers to select a pickup date/time, delivery date/time or ship at checkout  
* Enable a scheduler for the pickup and delivery time slots
* Pickup and delivery range uses Shipping Zones to enable restrictions
* Buy Now [Order Hours Scheduler Delivery](https://www.bizswoop.com/product/delivery/)


== Installation ==

1. Upload Woocommerce Order Hours Scheduler to the /wp-content/plugins/ directory
2. Activate the plugin through the Plugins menu in WordPress
3. Now select from the WooCommerce menu Order Hours Setting and edit your settings
4. Customize your schedule, alert bar and alert button unique to your store requirements
...
3. Settings Alert Bar

4. Settings Alert Checkout Button
