...
if(!defined('\Zhours\ASPECT_PREFIX')) {
	define('Zhours\ASPECT_PREFIX', '');
}
...
abstract class Base
{
    ...
    public function getLabelText() {
        if (!isset($this->labelText) || empty($this->labelText)) {
            return '';
        }
    ...
    public function setPluginHookName($name) {
        if (is_string($name)) {
            $this->pluginHookName = $name;
        }
        return $this;
    }

    public function getPluginHookName() {
        return $this->pluginHookName;
    }
